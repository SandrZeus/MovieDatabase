...
CREATE TABLE `filmsdirectors` (
  ...
  CONSTRAINT `filmsdirectors_ibfk_1` FOREIGN KEY (`FilmID`) REFERENCES `films` (`FilmID`),
  CONSTRAINT `filmsdirectors_ibfk_2` FOREIGN KEY (`DirectorID`) REFERENCES `directors` (`DirectorID`)
...
INSERT INTO `filmsdirectors` VALUES (1,1),(2,2),(4,2),(3,3),(10,3),(5,4),(6,5),(9,5),(7,6),(8,7);
